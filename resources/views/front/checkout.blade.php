                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                      <div class="single-form form-default">
                        ...
                        <div class="form-input form">
                          <x-form.input name="addr[billing][street]" type="text" placeholder="Street Address" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="single-form form-default">
                        ...
                        <div class="form-input form">
                          ...
                          <x-form.select name="addr[billing][country]" type="text" placeholder="Country" :options="$countries" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <div class="single-form form-default">
                        <label>Street Address</label>
                        <div class="form-input form">
                          <x-form.input name="addr[shipping][street]" type="text" placeholder="Street Address" />
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                      <div class="single-form form-default">
                        ...
                        <div class="form-input form">
                          <div class="select-items">
                          <x-form.select name="addr[shipping][country]" type="text" placeholder="Country" :options="$countries" />
                          </div>
                        </div>
                      </div>
                    </div>
